...
export const views: Record<LastLevelRouteKey, RouteComponent | (() => Promise<RouteComponent>)> = {
  ...
  "cad-spec": () => import("@/views/cad-spec/index.vue"),
  "component-build": () => import("@/views/component-build/index.vue"),
  "feature-center": () => import("@/views/feature-center/index.vue"),
  ...
  "patent-annotation": () => import("@/views/patent-annotation/index.vue"),
