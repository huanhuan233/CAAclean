...
echo [INFO] CATIA V5R21 failed-case repair v1.0.3
echo [INFO] Output: %OUT_DIR%
echo [INFO] Preserving passed fixtures: rib_slot, pattern, gsd_analytic
echo [INFO] Running only: fillet, chamfer, shaft_groove, shell_thickness, boolean, pressure
echo.
...
for %%C in (fillet chamfer shaft_groove shell_thickness boolean pressure) do (
  echo ============================================================
  echo [CASE] %%C
