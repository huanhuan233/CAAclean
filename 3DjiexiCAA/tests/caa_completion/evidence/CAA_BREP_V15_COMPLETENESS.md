...
Full completion-contract validation still reports expected failures for persistent Feature-Topology history and related authoritative relation semantics. Those failures were not hidden or downgraded. Remaining B-Rep work before final sealing includes broader real Shell coverage, trimmed UV-loop semantics, numeric measurement cross-checks against CATIA measures, curvature sampling, and a formal NURBS topology fixture.
